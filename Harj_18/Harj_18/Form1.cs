...
namespace Harj_18
{
    public partial class AvainhenkilotForm : Form
    {
        ...
        {
            TittaliLB.Text = yhteys.Rows[vastuuhloCB.SelectedIndex]["VTitteli"].ToString();
        ...
        private void taytaoppilaitosTaulukko()
        {
            ...
            oppilaitos.Rows.Add(4, "Keuda", "Sideliuksenväylä 55 A", "04400", "Järvenpää", "09 27 381");
        }
        ...
        private void taytaVastuuHenkilotTaulukko()
        {
            ...
            vastuuHenkilot.Rows.Add(1, "Eeva Sahlman", "Rehtori", "Kampus 4", "eeva.sahman@hel.fi", "040 336 1017");
